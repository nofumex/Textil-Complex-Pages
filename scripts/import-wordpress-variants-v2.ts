...
import { WPVariantsImporterV2 } from '../src/lib/wp-variants-import-v2';
import fs from 'fs';
import path from 'path';

const prisma = new PrismaClient();

async function importWordPressVariantsV2() {
  console.log('📥 Импорт товаров с вариациями из WordPress XML (v2)...\n');
  ...
  try {
    ...
    const importer = new WPVariantsImporterV2();
